...
class news extends frontControllerApplication
{
	...
	private function submissionForm ()
	{
		...
		$form->setOutputEmail ($this->settings['webmaster'], $this->settings['administratorEmail'], 'New news submission from ' . ($this->userName ? $this->userName : $this->user), NULL, 'email');
